...
#
# Note: /execute-team, /review-plan-team, /security-audit-team are Claude Code-only
# (agent teams are a Claude Code feature). They have no portable workflow equivalent
# and are intentionally omitted from this sync check. Only /review-code-team has a
# portable counterpart at prompts/workflows/review-code-team.md (used by other
# platforms to invoke the team-style review prompt sequentially).
# See README platform-support table and docs/guides/agent-teams.md for context.
MAPPINGS="
...
review-code-team:review-code-team
